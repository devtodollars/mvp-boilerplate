          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center font-body gap-4" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <a className="btn text-white bg-primarybg hover:bg-primary hover:text-white w-full mb-4 sm:w-auto sm:mb-0 hover:no-underline" href="#0">Join Discord</a>
                </div>
                <div className="flex items-center">
                  <a className="text-white" href="#0">See Boilerplate →</a>
                </div>
              </div>
            </div>
          </div>
